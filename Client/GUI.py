...
def RGB_to_Hex(r, g, b):
    return (
        ("#" + str(hex(r))[-2:] + str(hex(g))[-2:] + str(hex(b))[-2:])
        .replace("x", "0")
        .upper()
    )
...
def getposHsv(event, x, y, flags, param):
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        tcpClicSock.send(
            (
                "findColorSet %s %s %s"
                % (HSVimg[y, x][0], HSVimg[y, x][1], HSVimg[y, x][2])
            ).encode()
        )
        getBGR = source[y, x]
        var_R.set(getBGR[2])
        ...
        var_B.set(getBGR[0])
        canvas_show.config(
            bg=RGB_to_Hex(int(var_R.get()), int(var_G.get()), int(var_B.get()))
        )
...
def advanced_OSD_add(draw_on, X, Y):  # 1
    ...
    cv2.putText(
        ...
        ("horizontal line"),
        (X_e + 10, Y_e),
        cv2.FONT_HERSHEY_SIMPLEX,  # Using a default font
        0.5,
        (0, 255, 0),
        1,
        cv2.LINE_AA,
    ...
    cv2.line(
        draw_on, (X_s_short, Y_s_short + 90), (X_e_short, Y_e_short + 90), (0, 255, 0)
    )
    cv2.line(
        draw_on, (X_s_short, Y_s_short + 180), (X_e_short, Y_e_short + 180), (0, 255, 0)
    )
    cv2.line(
        draw_on, (X_s_short, Y_s_short + 360), (X_e_short, Y_e_short + 360), (0, 255, 0)
    )
    cv2.line(
        draw_on, (X_s_short, Y_s_short + 450), (X_e_short, Y_e_short + 450), (0, 255, 0)
    )
    ...
    while True:
        try:
            ...
            try:
                ...
                DIR_show = 0  # CAR_DIR is not defined in this file int(CAR_DIR)
                if DIR_show > 0:
                    cv2.rectangle(
                        source, ((320 - DIR_show), 323), (320, 327), (255, 255, 255)
                    )
                elif DIR_show < 0:
                    cv2.rectangle(
                        source, (320, 323), ((320 - DIR_show), 327), (255, 255, 255)
                    )
            except Exception:
                pass
...
def replace_num(initial, new_num):  # Call this function to replace data in '.txt' file
    pass  # Function doesnt seem to be doing anything at the moment
...
def servo_buttons(x, y):
    ...
    Btn_1 = tk.Button(
        root, width=8, text="A_Up", fg=color_text, bg=color_btn, relief="ridge"
    )
    ...
    Btn_1 = tk.Button(
        root, width=8, text="A_Down", fg=color_text, bg=color_btn, relief="ridge"
    )
    ...
    Btn_2 = tk.Button(
        root, width=8, text="A_Right", fg=color_text, bg=color_btn, relief="ridge"
    )
    ...
    Btn_5 = tk.Button(
        root, width=8, text="H_Down", fg=color_text, bg=color_btn, relief="ridge"
    )
    ...
    Btn_6 = tk.Button(
        root, width=8, text="H_Up", fg=color_text, bg=color_btn, relief="ridge"
    )
...
def connent_input(x, y):
    global E1, Btn14
    E1 = tk.Entry(
        root, show=None, width=16, bg="#37474F", fg="#eceff1", textvariable=""
    )
    # test ip
    E1.insert(0, "")
...
def switch_button(x, y):
    ...
    Btn_Switch_1 = tk.Button(
        root, width=8, text="Port 1", fg=color_text, bg=color_btn, relief="ridge"
    )
    Btn_Switch_2 = tk.Button(
        root, width=8, text="Port 2", fg=color_text, bg=color_btn, relief="ridge"
    )
    Btn_Switch_3 = tk.Button(
        root, width=8, text="Port 3", fg=color_text, bg=color_btn, relief="ridge"
    )
...
def scale_FL(x, y, w):
    ...
    Btn_CVFL = tk.Button(
        root, width=23, text="CV FL", fg=color_text, bg="#212121", relief="ridge"
    )
...
def scale_FC(x, y, w):
    ...
    Btn_WB = tk.Button(
        root, width=23, text="Color Set", fg=color_text, bg="#212121", relief="ridge"
    )
    Btn_WB.place(x=x + w + 21, y=y + 60)
...
def function_buttons(x, y):
    ...
    Btn_function_1 = tk.Button(
        root, width=8, text="TrackLine", fg=color_text, bg=color_btn, relief="ridge"
    )
    Btn_function_2 = tk.Button(
        root, width=8, text="FindColor", fg=color_text, bg=color_btn, relief="ridge"
    )
    Btn_function_3 = tk.Button(
        root, width=8, text="MotionGet", fg=color_text, bg=color_btn, relief="ridge"
    )
    Btn_function_4 = tk.Button(
        root, width=8, text="Police", fg=color_text, bg=color_btn, relief="ridge"
    )
...
def config_buttons(x, y):
    ...
    Btn_SiRight = tk.Button(
        root,
        width=16,
        text="PWM0 Turn Right>",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_SetGearMiddle = tk.Button(
        root,
        width=16,
        text="<PWM0 Middle Set>",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWM1MS = tk.Button(
        root,
        width=16,
        text="PWM1 Middle Set",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWM2MS = tk.Button(
        root,
        width=16,
        text="PWM2 Middle Set",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWM3MS = tk.Button(
        root,
        width=16,
        text="PWM3 Middle Set",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWM4MS = tk.Button(
        root,
        width=16,
        text="PWM4 Middle Set",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWM5MS = tk.Button(
        root,
        width=16,
        text="Move to InitPos",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
    ...
    Btn_PWMDefault = tk.Button(
        root,
        width=16,
        text="PWM Default Set",
        fg=color_text,
        bg=color_btn,
        relief="ridge",
    )
